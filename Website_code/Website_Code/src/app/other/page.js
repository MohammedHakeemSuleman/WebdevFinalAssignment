...
<div id="Menubutton"><a className="Men">menu</a></div>
    ...
    <div  id="bars">
        ...
        <div id="bar3"><a href="./student">student</a></div>
    </div>
    ...
    <Image  src='/photo/IMG_1099.jpeg' alt ="slide 1" sizes='100vw' width={0} height={0} style={{width:'100%',height:'auto'}}/>
    </div>
</div>
...
Breaches of the rules may be dealt with by specific Library and Resource Centre Disciplinary Action (see below), including the withdrawal of some access, and if appropriate by invoking the College’s Regulations for Students, in the case of students, or in the case of staff through the appropriate College procedures as set out in the Staff Handbook. </p>
</div>
...
Users of the Library and Resource Centre are reminded that they must be willing to show  ID cards or other identification when requested to do so by College staff.</li>
      </ul>
    ...
    <Image  src='/photo/IMG_1089.jpeg' alt ="slide 1" sizes='100vw' width={0} height={0} style={{width:'100%',height:'auto'}}/>
...
<div className="teacher1">
    <div id="box1"><h1>Use Of Facilities:</h1>
    <ul>
